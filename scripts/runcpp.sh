#!/bin/bash
g++ -O3 frequency-quads/gen_random_graph.cpp -o gen_random_graph && ./gen_random_graph $1 $2 > input_graph.txt
g++ -O3 frequency-quads/freqquad.cpp -o freqquad && ./freqquad input_graph.txt $3 $2 > output_graph.txt
